    ...
    <div className="third-section">
      ...
      <div className="feature-grid">
        <div className="feature-box">
          <img src="/images/secure.svg" alt="Secure" className="feature-img-icon" />
        ...
        <div className="feature-box">
          <img src="/images/cross-platform.svg" alt="Cross Platform" className="feature-img-icon" />
        ...
        <div className="feature-box">
          <img src="/images/real-time.svg" alt="Real-Time" className="feature-img-icon" />
