    ...
    return (
        <div className="sec-homepage">
            <div className="container">
                <h1 className="section-title">Collaborate with others in  <span className="highlight-blue">real time</span></h1>
                ...
                <div className="features">
                    <div className="feature-card">
                        <img src="/video-call.png" alt="Video Call" className="feature-icon" />
                    ...
                    <div className="feature-card">
                        <img src="/canvas-icon.png" alt="Canvas" className="feature-icon" />
