...
// You can optionally pass roomId and username from props/context
const socket = io("https://canvas-backend-ft79.onrender.com/");
...
const Canvas = () => {
  ...
  // Join a room (can be dynamic, here it's hardcoded for simplicity)
  useEffect(() => {
    socket.emit("join-room", {
      roomId: "shared-room", // Replace with dynamic if needed
      userId: socket.id,
